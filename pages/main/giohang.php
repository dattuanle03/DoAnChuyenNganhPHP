...
<table style="width:100%; text-align:center; margin-top:20px;" border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="pages/main/themgiohang.php?cong=<?php echo $cart_item['id'] ?>"><i class="fas fa-plus fa-style" aria-hidden="true"></i></a>
                    <?php echo $cart_item['soluong'] ?>
                    <a href="pages/main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>"><i class="fas fa-minus fa-style" aria-hidden="true"></i></a>
                </td>
